...
namespace Kamgam.Terrain25DLib
{
	...
	public class Terrain25DEditor : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			// Cancel if prefab
#if UNITY_EDITOR
			if (PrefabUtility.IsPartOfAnyPrefab(terrain.gameObject))
			{
		...
		[MenuItem("Tools/2.5D Terrain/Manual", false, 501)]
		static void OpenManual(MenuCommand menuCommand)
		{
            Terrain25DSettings.OpenOfflineManual();
		}
		...
		[MenuItem("Tools/2.5D Terrain/More Asset by KAMGAM", priority = 602)]
		public static void MoreAssets()
		{
			Application.OpenURL("https://assetstore.unity.com/publishers/37829?aid=1100lqC54&pubref=asset");
		}

		[MenuItem("Tools/2.5D Terrain/Version: " + Terrain25DSettings.Version, priority = 701)]
		public static void VersionLog()
		{
            Debug.Log("2.5D Terrain Version " + Terrain25DSettings.Version);
		}
